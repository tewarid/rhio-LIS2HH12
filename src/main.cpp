...
void loop() {
  ...
  bool t = lis.readAccelUsingStatus(&x,&y,&z);
  lis.readAccelWithoutConvert(&x3,&y3,&z3);
  x1=x;
  y2=y;
  z1=z;
  x4=x3;
  ...
  Serial.print("x1: "); Serial.println(x4);
  Serial.print("y1: "); Serial.println(y4);
  Serial.print("z1: "); Serial.println(z4);  
  Serial.println(t);
  delay(2000);
}
