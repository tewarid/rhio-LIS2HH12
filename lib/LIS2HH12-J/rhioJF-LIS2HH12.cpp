...
void LIS2HH12::setSPI(byte csPin){
  chipSelectPin = csPin;
}

void LIS2HH12::setI2C(byte Address){
  I2CAddress=Address;
}
 ...
 * Power Down |    0    |             |             |             |
 */
void LIS2HH12::setFrequency(byte ODR){
 ...
 *   None   |    0
 */
void LIS2HH12::setAxis(byte ZYX){
 ...
 *    50    |    192 
 */
void LIS2HH12::setanalogBandwidth(byte BW){
 ...
 *    ODR/200  |    96 
 */
void LIS2HH12::setdigitalLPF(byte LPFcutOff){ //Mismo registro que HPF?
...
void LIS2HH12::setActiveInactive(byte threshold, byte duration){  
 ...
 */
void LIS2HH12::setSelfTest(byte mode){
 ...
 *  dataHPF |  dataHPF |    3 
 */
void LIS2HH12::setIntHPFData(byte IntHPF){
 ...
 *   Reference signal |   8
 */
void LIS2HH12::setHPF(byte HPF){
  writeRegister(HPF,LIS2HH12_CTRL2,231); 
}

void LIS2HH12::setFDS(byte OutData){
  if(OutData==OnHPF){
 ...
 *    ODR/200  |    96 
 */
void LIS2HH12::setCutOffHPF(byte HPFcutOff){
 ...
 */
  void LIS2HH12::setIntG1Mode(byte IntMode){ //Revisar porque hay dos registros iguales
...
//*************************UTILITY*************************//
  uint8_t LIS2HH12::readRegister(byte regis){
...
void LIS2HH12::writeRegister(byte val, byte regis, byte bt){ 
...
char LIS2HH12::readbit(byte regis,int loc){
  uint8_t val;
  bool bit;
